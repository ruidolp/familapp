...
export function PriceQuantityScatter() {
  return (
    <Card className="p-6">
      <h3 className="text-lg font-semibold mb-4">📊 Precio Unitario vs Cantidad Comprada</h3>
              ...
              if (active && payload && payload.length) {
                ...
                return (
                  <div className="bg-card border border-border rounded-lg p-3 shadow-lg">
                    <p className="font-semibold text-sm">{data.producto}</p>
                    <p className="text-xs text-muted-foreground">🏪 {data.tienda}</p>
